...
def play_song():
    ...
    try:
        ...
        mixer.music.play()
        song_title_lable.config(fg="green",text="Now Playing : " + str(song_title))
    except Exception as e :
        print(e)
        song_title_lable.config(fg="red",text="Error Playing Track")
...
def reduce_volume():
    try:
        ...
        print(e)
        song_title_lable.config(fg="red",text="Track hasn't been selected yet")
...
def pause():
    try:
        ...
        print(e)
        song_title_lable.config(fg="red",text="Track hasn't selected yet")
...
# Lables
Label(master, text="VK Music Player",font=("Calibri",15),fg='red').grid(sticky="N",row=0,padx=120)
...
song_title_lable = Label(master,font=("Calibri",12))
song_title_lable.grid(stick="N",row=3)
